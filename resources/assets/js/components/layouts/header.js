            ...
            <ul className="custom-scrollbar">
                ...
                <li>
                    <ul className="collapsible collapsible-accordion">
                        <li><a className="collapsible-header waves-effect arrow-r"><i className="fa fa-chevron-right"></i> Submit blog<i className="fa fa-angle-down rotate-icon"></i></a>
                        ...
                        <li><a className="collapsible-header waves-effect arrow-r"><i className="fa fa-hand-pointer-o"></i> Instruction<i className="fa fa-angle-down rotate-icon"></i></a>
                            <div className="collapsible-body">
                                <ul>
                        ...
                        <li><a className="collapsible-header waves-effect arrow-r"><i className="fa fa-envelope-o"></i> Contact me<i className="fa fa-angle-down rotate-icon"></i></a>
                            <div className="collapsible-body">
                                <ul>
